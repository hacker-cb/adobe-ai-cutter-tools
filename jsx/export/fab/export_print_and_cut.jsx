...
(function(){
    ...
    */
    ...
    var restoreState = function() {
        ...
        var restorePdfPreset = function(field, presetName, defaultValue) {
            var preset = CutterToolsPrefs.get(presetName);
            ...
            if (preset == PREFS_DEFAULT_PDF_PRESET) {
                ...
                if (sel != null) {
                    ...
                    CutterToolsPrefs.unset(presetName);
                }
            }
        };
    ...
    var saveState = function() {
        var savePdfPreset = function(field, presetName) {
            if (field.selection) {
                if (field.selection.index == 0){
                    CutterToolsPrefs.set(presetName, PREFS_DEFAULT_PDF_PRESET);
                } else {
                    CutterToolsPrefs.set(presetName, field.selection.text);
                }
            }
        };
        ...
        try {
            ...
            var options = {
                ...
                exportTypes: {
                    ...
                    'CUT': pdfPrintEnable.value,
                    'PRINT': pdfCutEnable.value
                },
                exportPresets: {
